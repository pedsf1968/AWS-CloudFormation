...
aws cloudformation create-stack --stack-name ROOT-10-network --template-body file://_network.yaml --parameters file://0_parameters.json --capabilities CAPABILITY_AUTO_EXPAND
...
aws cloudformation delete-stack --stack-name ROOT-10-network